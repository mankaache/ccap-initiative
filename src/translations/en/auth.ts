export const auth = {
    ...
    'auth.condition1': 'By checking this box, I accept the',
    'auth.condition2': 'Participation Charter',
    'auth.condition3': 'To publish my projects on the platform, I will download, sign, and return',
    'auth.condition4': 'the publication authorization',
    'auth.condition5': 'document to the email address indicated at the bottom of the page.',
